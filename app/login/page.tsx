    ...
    <div className="min-h-screen bg-navy-900 flex flex-col items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md bg-navy-800 border border-gold/20 rounded-xl p-8 shadow-2xl">
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl text-cream-100 mb-1">स्वागत छ</h1>
          <p className="text-cream-300/50 text-xs mb-1">Welcome Back</p>
        ...
        >
          ...
          <span className="text-cream-300/50 text-xs">(Continue with Google)</span>
        </a>
        ...
        <p className="text-center text-cream-300/60 text-sm mt-6">
          ...
          <span className="text-cream-300/30"> (Register)</span>
        </p>
      </div>
    </div>
  );
